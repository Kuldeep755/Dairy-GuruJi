    ...
    <section className="px-6 py-32 bg-bg-light relative overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl relative z-10">
        <div className="mb-20 text-center">
          ...
          <p className="mt-6 text-xl text-text-dark/60 font-medium">
        ...
        <div className="space-y-8">
          {faqs.map((item, index) => (
            ...
            >
              <h3 className="text-2xl font-black text-text-dark mb-6 flex items-start gap-6">
              ...
              <div className="pl-16">
                <p className="text-xl text-text-dark/70 leading-relaxed font-medium">
                  {item.a}
                </p>
              </div>
            </motion.div>
